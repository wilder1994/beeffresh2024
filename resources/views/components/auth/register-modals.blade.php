...
<x-account.dialog name="register-client-confirm" maxWidth="md" zIndex="z-[200]" :show="$openConfirm">
    <div class="bf-surface shadow-xl p-6 text-center">
...
<x-account.dialog name="register-client" maxWidth="2xl" zIndex="z-[210]" :show="$openRegister">
    <div class="bf-surface shadow-xl p-5 sm:p-6 overflow-y-auto max-h-[min(92vh,44rem)]">
        <header class="mb-4 pb-3 border-b border-[var(--bf-border-brand-subtle)]">
