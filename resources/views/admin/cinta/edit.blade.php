                ...
                @if($slide)
                    ...
                    >
                        ...
                        <div class="absolute top-1.5 right-1.5 flex gap-1 opacity-0 group-hover:opacity-100 focus-within:opacity-100 transition-opacity z-10">
                            ...
                            <x-bf.delete-action
                                :action="route('admin.cinta.destroy', $slide)"
                                confirm-title="¿Quitar esta imagen de la cinta?"
                                confirm-message="La diapositiva se eliminará del carrusel de inicio."
                                button-class="bf-cinta-slot-btn bf-cinta-slot-btn--danger"
                                label=""
                            >
