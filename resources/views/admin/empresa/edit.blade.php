...
@section('contenido')
    <div class="max-w-3xl mx-auto px-3 sm:px-4 py-4">
        <p class="text-xs sm:text-sm text-[var(--bf-muted)] mb-4 leading-snug">
        ...
        <form method="post" action="{{ route('admin.empresa.update') }}" class="bf-form-panel bf-form-panel-tight space-y-3">
            @csrf
            @method('PUT')
