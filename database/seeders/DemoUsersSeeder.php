    ...
    public function run(): void
    {
        ...
        $definitions = [
            ...
            RoleSlug::EMPLOYEE => [
                ...
                [
                    'email' => 'despachador2@demo.beeffresh.test',
                    'first_name' => 'Felipe',
                    'last_name' => 'Arango',
                    'phone' => '3165550204',
                    'document_type' => 'CC',
                    ...
                    'eps' => 'Sanitas EPS',
                    'arl' => 'Positiva ARL',
                    'emergency_contact' => 'Marta Arango',
                    'emergency_phone' => '3028005566',
                    'home_address' => 'Carrera 100 # 14-32, Barrio Ciudad Jardín',
                    'home_city' => 'Cali',
                    'home_state' => 'Valle del Cauca',
                    'home_country' => 'CO',
                    'home_latitude' => 3.367891,
                    'home_longitude' => -76.531245,
                    'permissions' => [PermissionKey::MODULE_ORDERS],
                ],
            ],
            RoleSlug::CUSTOMER => [
